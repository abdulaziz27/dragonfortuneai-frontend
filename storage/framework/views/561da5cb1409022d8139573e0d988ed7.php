...
<div class="df-panel p-3" style="min-height: 350px;" x-data="historyFundingChart('<?php echo e($symbol ?? 'BTC'); ?>', '<?php echo e($interval ?? '4h'); ?>')">
    <!-- Header -->
...
<?php /**PATH C:\DATASAID\Said\Bisnis\quantwaru\frontend\dragonfortuneai-frontend\resources\views/components/funding/history-chart.blade.php ENDPATH**/ ?>