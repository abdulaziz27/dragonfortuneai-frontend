...
<div class="df-panel p-4 h-100" x-data="marketInsightsCard('<?php echo e($symbol ?? 'BTCUSDT'); ?>', '<?php echo e($timeframe ?? '5min'); ?>', '<?php echo e($exchange ?? 'binance'); ?>')">
    <!-- Header -->
...
<?php /**PATH C:\DATASAID\Said\Bisnis\quantwaru\frontend\dragonfortuneai-frontend\resources\views/components/vwap/market-insights.blade.php ENDPATH**/ ?>