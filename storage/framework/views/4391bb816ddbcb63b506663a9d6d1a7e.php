...
<head>
    ...
    <title><?php echo e(config('app.name', 'DragonFortune AI')); ?></title>
...
<body>
                    ...
                    <ul class="df-sidebar-menu">
                        ...
                        <li class="df-sidebar-menu-item">
                            ...
                            <div class="df-submenu<?php echo e(request()->routeIs('derivatives.*') ? ' show' : ''); ?>" :class="{ 'show': openSubmenus['derivatives'] }">
                                ...
                                <a href="/derivatives/liquidations" class="df-submenu-item <?php echo e(request()->routeIs('derivatives.liquidations') ? 'active' : ''); ?>" style="color: var(--foreground);" @click="closeSidebar()">Liquidations</a>
                        ...
                        <li class="df-sidebar-menu-item">
                            ...
                            <div class="df-submenu<?php echo e(request()->routeIs('spot-microstructure.*') ? ' show' : ''); ?>" :class="{ 'show': openSubmenus['spot-microstructure'] }">
                                <a href="/spot-microstructure/trades" class="df-submenu-item <?php echo e(request()->routeIs('spot-microstructure.trades') ? 'active' : ''); ?>" style="color: var(--foreground);" @click="closeSidebar()">Trades & Large Orders</a>
                                <a href="/spot-microstructure/orderbook-snapshots" class="df-submenu-item <?php echo e(request()->routeIs('spot-microstructure.orderbook-snapshots') ? 'active' : ''); ?>" style="color: var(--foreground);" @click="closeSidebar()">Orderbook Snapshots</a>
                                <a href="/spot-microstructure/vwap-twap" class="df-submenu-item <?php echo e(request()->routeIs('spot-microstructure.vwap-twap') ? 'active' : ''); ?>" style="color: var(--foreground);" @click="closeSidebar()">VWAP & TWAP</a>
                                <a href="/spot-microstructure/volume-trade-stats" class="df-submenu-item <?php echo e(request()->routeIs('spot-microstructure.volume-trade-stats') ? 'active' : ''); ?>" style="color: var(--foreground);" @click="closeSidebar()">Volume & Trade Stats</a>
                            </div>
                        </li>
                        <li class="df-sidebar-menu-item">
                            ...
                            <div class="df-submenu<?php echo e(request()->routeIs('onchain-metrics.*') || request()->routeIs('onchain-ethereum.*') || request()->routeIs('onchain-exchange.*') || request()->routeIs('onchain-mining-price.*') ? ' show' : ''); ?>" :class="{ 'show': openSubmenus['onchain-metrics'] }">
                                <a href="/onchain-metrics" class="df-submenu-item <?php echo e(request()->routeIs('onchain-metrics.index') || request()->routeIs('onchain-metrics.dashboard') ? 'active' : ''); ?>" style="color: var(--foreground);" @click="closeSidebar()">Core Metrics (with CQ)</a>
                                <a href="/onchain-ethereum" class="df-submenu-item <?php echo e(request()->routeIs('onchain-ethereum.*') ? 'active' : ''); ?>" style="color: var(--foreground);" @click="closeSidebar()">Ethereum Network</a>
                                <a href="/onchain-exchange" class="df-submenu-item <?php echo e(request()->routeIs('onchain-exchange.*') ? 'active' : ''); ?>" style="color: var(--foreground);" @click="closeSidebar()">Exchange Reserves</a>
                                <a href="/onchain-mining-price" class="df-submenu-item <?php echo e(request()->routeIs('onchain-mining-price.*') ? 'active' : ''); ?>" style="color: var(--foreground);" @click="closeSidebar()">Mining & Price</a>
                            </div>
                        </li>
                        <li class="df-sidebar-menu-item">
                            <a href="/options-metrics/dashboard" class="df-sidebar-menu-button <?php echo e(request()->routeIs('options-metrics.dashboard') ? 'active' : ''); ?>" @click="closeSidebar()">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
                                    <path d="M8 12h8"/>
                                    <path d="M12 8v8"/>
    ...
    <script src="<?php echo e(asset('js/onchain-shared-state.js')); ?>"></script>
    
    
    <script src="<?php echo e(asset('js/onchain-cache-helper.js')); ?>"></script>
    
    
    <script src="<?php echo e(asset('js/onchain-error-handler.js')); ?>"></script>
    
    
    <script src="<?php echo e(asset('js/onchain-chart-optimizer.js')); ?>"></script>
...
<?php /**PATH C:\DATASAID\Said\Bisnis\quantwaru\frontend\dragonfortuneai-frontend\resources\views/layouts/app.blade.php ENDPATH**/ ?>