<?php $__env->startSection('content'); ?>
    ...
    <div class="d-flex flex-column h-100 gap-3" x-data="onchainExchangeController()">
        ...
        <!-- Summary Cards Row -->
        <div class="row g-3">
            <?php echo $__env->make('components.onchain-exchange.exchange-summary-cards', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
        ...
        <div class="row g-3">
            ...
            <div class="col-lg-8">
                <?php echo $__env->make('components.onchain-exchange.exchange-reserves-chart', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        ...
        <div class="row g-3">
            ...
            <div class="col-lg-8">
                <?php echo $__env->make('components.onchain-exchange.market-indicators-chart', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(asset('js/onchain-exchange-controller.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\DATASAID\Said\Bisnis\quantwaru\frontend\dragonfortuneai-frontend\resources\views/onchain-exchange/dashboard.blade.php ENDPATH**/ ?>