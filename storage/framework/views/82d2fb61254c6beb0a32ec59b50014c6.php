...
<div class="df-panel p-3" x-data="fundingHeatmap()" x-init="init()">
    <div class="d-flex justify-content-between align-items-center mb-2">
        <h5 class="mb-0"><?php echo e($title ?? 'Funding Heatmap'); ?></h5>
...
<?php /**PATH C:\DATASAID\Said\Bisnis\quantwaru\frontend\dragonfortuneai-frontend\resources\views/components/funding/heatmap.blade.php ENDPATH**/ ?>