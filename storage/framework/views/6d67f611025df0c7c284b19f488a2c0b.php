<?php $__env->startSection('content'); ?>
    ...
    <div class="d-flex flex-column h-100 gap-3" x-data="onchainMiningPriceController()">
        ...
        <!-- Summary Cards Row -->
        <div class="row g-3">
            <?php echo $__env->make('components.onchain-mining-price.mining-price-summary', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
        ...
        <div class="row g-3">
            <!-- Miners MPI Chart -->
            <div class="col-lg-8">
                <?php echo $__env->make('components.onchain-mining-price.miners-mpi-chart', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        ...
        <div class="row g-3">
            <!-- Price Charts -->
            <div class="col-lg-12">
                <?php echo $__env->make('components.onchain-mining-price.price-charts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(asset('js/onchain-mining-price-controller.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\DATASAID\Said\Bisnis\quantwaru\frontend\dragonfortuneai-frontend\resources\views/onchain-mining-price/dashboard.blade.php ENDPATH**/ ?>