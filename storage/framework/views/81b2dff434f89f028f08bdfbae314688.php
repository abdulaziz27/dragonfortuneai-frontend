<?php $__env->startSection('content'); ?>
    ...
    <div class="d-flex flex-column h-100 gap-3" x-data="liquidationsController()">
        ...
        <div class="row g-3">
            <div class="col-12">
                <?php echo $__env->make('components.liquidations.analytics-summary', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>
        ...
        <div class="row g-3">
            <div class="col-12">
                <?php echo $__env->make('components.liquidations.liquidation-stream', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>
        ...
        <div class="row g-3">
            <div class="col-12">
                <?php echo $__env->make('components.liquidations.historical-chart', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>
        ...
        <div class="row g-3">
            <div class="col-12">
                <?php echo $__env->make('components.liquidations.heatmap-chart', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>
        ...
        <div class="row g-3">
            <!-- Exchange Comparison -->
            <div class="col-lg-6">
                <?php echo $__env->make('components.liquidations.exchange-comparison', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>

            <!-- Exchange Breakdown -->
            <div class="col-lg-6">
                <?php echo $__env->make('components.liquidations.coin-list-table', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(asset('js/liquidations-controller.js')); ?>"></script>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\DATASAID\Said\Bisnis\quantwaru\frontend\dragonfortuneai-frontend\resources\views/derivatives/liquidations.blade.php ENDPATH**/ ?>