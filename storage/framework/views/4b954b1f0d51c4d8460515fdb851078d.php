<?php $__env->startSection('content'); ?>
    ...
    <div class="d-flex flex-column h-100 gap-3" x-data="vwapController()">
        ...
        <div class="row g-3">
            <!-- Latest Stats Card -->
            <div class="col-lg-4">
                <?php echo $__env->make('components.vwap.latest-stats', [
                    'symbol' => 'BTCUSDT',
                    'timeframe' => '5min',
                    'exchange' => 'binance'
            ...
            <!-- Market Insights -->
            <div class="col-lg-8">
                <?php echo $__env->make('components.vwap.market-insights', [
                    'symbol' => 'BTCUSDT',
                    'timeframe' => '5min',
                    'exchange' => 'binance'
                ], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <div class="row g-3">
            <div class="col-12">
                <?php echo $__env->make('components.vwap.bands-chart', [
                    'symbol' => 'BTCUSDT',
                    'timeframe' => '5min',
                    'exchange' => 'binance',
                    'limit' => 200
        ...
        <div class="row g-3">
            <div class="col-12">
                <?php echo $__env->make('components.vwap.history-table', [
                    'symbol' => 'BTCUSDT',
                    'timeframe' => '5min',
                    'exchange' => 'binance',
                    'limit' => 100
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(asset('js/vwap-controller.js')); ?>"></script>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\DATASAID\Said\Bisnis\quantwaru\frontend\dragonfortuneai-frontend\resources\views/spot-microstructure/vwap-twap.blade.php ENDPATH**/ ?>