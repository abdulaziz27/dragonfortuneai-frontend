<?php $__env->startSection('content'); ?>
    ...
    <div class="d-flex flex-column h-100 gap-3" x-data="onchainEthereumController()">
        ...
        <!-- Summary Cards Row -->
        <div class="row g-3">
            <?php echo $__env->make('components.onchain-ethereum.eth-summary-cards', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
        ...
        <div class="row g-3">
            <!-- Network Gas Chart -->
            <div class="col-lg-8">
                <?php echo $__env->make('components.onchain-ethereum.network-gas-chart', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        ...
        <div class="row g-3">
            ...
            <div class="col-lg-8">
                <?php echo $__env->make('components.onchain-ethereum.staking-deposits-chart', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(asset('js/chart-init-helper.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('js/onchain-ethereum-controller.js')); ?>?v=<?php echo e(time()); ?>"></script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\DATASAID\Said\Bisnis\quantwaru\frontend\dragonfortuneai-frontend\resources\views/onchain-ethereum/dashboard.blade.php ENDPATH**/ ?>