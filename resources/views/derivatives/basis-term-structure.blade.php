...
@section('content')
    {{--
        Basis & Term Structure Analytics Dashboard
    ...
    <div class="d-flex flex-column h-100 gap-3" x-data="basisTermStructureController()">
        ...
        <div class="row g-3">
            <!-- Basis History Chart -->
            <div class="col-lg-8">
                @include('components.basis.history-chart', ['symbol' => 'BTC'])
            </div>
        ...
        <div class="row g-3">
            <div class="col-12">
                @include('components.basis.term-structure-chart', ['symbol' => 'BTC'])
            </div>
        </div>
...
@section('scripts')
    ...
    <script src="{{ asset('js/basis-term-structure-controller.js') }}"></script>
