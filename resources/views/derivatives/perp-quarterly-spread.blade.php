...
@section('content')
    ...
    <div class="d-flex flex-column h-100 gap-3" x-data="perpQuarterlySpreadHybridController()"
        <!-- Page Header -->
            ...
            <div class="col-12">
                <div class="tradingview-chart-container">
                    ...
                    <div class="chart-body">
                        <canvas id="perpQuarterlySpreadMainChart"></canvas>
                    </div>
...
@section('scripts')
    ...
    <script src="{{ asset('js/perp-quarterly-spread-hybrid-controller.js') }}"></script>
@endsection