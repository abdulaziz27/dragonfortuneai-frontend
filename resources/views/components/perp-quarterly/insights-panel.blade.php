...
function spreadInsightsPanel(initialSymbol = 'BTC', initialExchange = 'Binance') {
    return {
        ...
        structureInterpretation: 'Analyzing...',
        trendDirection: '--',
        trendChange: null,
        trendInterpretation: 'Calculating...',
        arbitrageScore: 0,
        arbitrageMessage: 'Analyzing...',
        avgSpread: null,
        minSpread: null,
        maxSpread: null,
        volatility: null,
        ...
        applyAnalytics(data) {
            ...
            const currentSpread = data.spread_bps?.current ?? 0;
            ...
            this.volatility = data.spread_bps?.std_dev ?? null;
            ...
            if (this.trendDirection.toLowerCase().includes('widening')) {
                this.trendInterpretation = 'Spread is expanding. Divergence between contracts increasing.';
            } else if (this.trendDirection.toLowerCase().includes('narrowing')) {
